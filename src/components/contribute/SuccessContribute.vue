<template>
    <div class="container">
        <div class="submitContribute">
            <img src="../../images/submitContribute.png" alt="">
            <div class="mybtn">
              <button type="button" class="btn btn-success" @click="success">
                <i class="fas fa-plus"></i>
                继续投稿
              </button>
              <button type="button" class="btn btn-success" @click="myContribute">
